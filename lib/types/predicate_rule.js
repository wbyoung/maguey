...
var PredicateRule = Class.extend(/** @lends PredicateRule# */ {
  ...
  expandsValue: function() {
    var fn = function(ex) { // jscs:ignore jsDoc
   ...
   *
   * The given transformation functions will be applied to the value in the
   * order in which they are provided to this function.
   *
   * @method
   * @public
